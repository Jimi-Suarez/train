export const SESSIONS = {
  ...
  pull: {
    ...
    lifts: [
      { id: 'pullup',      name: 'Pull-ups / Lat Pulldown',  sets: 4, repsMin: 2,  repsMax: 5, increment: 2.5, kpi: true, firstLift: true, bodyweight: true, restSeconds: 120, note: 'Pull-ups: max reps, add weight when easy. Pulldown: 4 challenging sets. Full hang at bottom.' },
